...
![Build and deploy status badge](https://github.com/cipscis/pubsub/actions/workflows/build-and-deploy.yml/badge.svg)
...
See [Pubsub documentation](https://cipscis.github.io/pubsub/)

## Development

You will need to install [Node.js](https://nodejs.org/en/) before working on this package.

1. Clone the repository using `git clone https://github.com/cipscis/pubsub.git`.
